...
public class gramatykaLexer extends Lexer {
	...
	private static String[] makeRuleNames() {
		return new String[] {
			"T__0", "T__1", "T__2", "T__3", "T__4", "T__5", "T__6", "T__7", "BIGGER", 
			"SMALLER", "EQUAL", "NOTEQUAL", "REPEAT", "ENDREPEAT", "INPUT", "OUTPUT", 
			"AND", "OR", "XOR", "NEG", "FLOAT", "DOUBLE", "STRINGTYPE", "INTTYPE", 
			"BOOLTYPE", "BOOLEAN", "ID", "REAL", "INT", "ADD", "MULTIPLY", "MINUS", 
